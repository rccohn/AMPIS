...
def preprocess_data(root_dir, target_dir, n_validation):
    """
    Reads images and annotation files in root_dir. Reads images in root_dir, converts them to png so all formatting is
    consistent, resizes images and saves them in target_dir. Reads the annotation file, stores masks in compressed
    format in target_dir.

    For this example, only images with 600 or fewer instances are saved.
    TODO implement this
    """
